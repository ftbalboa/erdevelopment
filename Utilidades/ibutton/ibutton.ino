...
void loop(void) {
  ...
  if(hey1 == ESCARA1 && hey2 == ESCARA2 && hey3 == ESCARA3 && hey4 == ESCARA4){Serial.println("OKA");digitalWrite(RELE, LOW);}else{Serial.println("nope ");digitalWrite(RELE, HIGH);}
  delay(250);
  laser();
}
//1
