...
int a3 = 0;
int a4 = 0;
const String ESCARA1 = "80357e7";
const String ESCARA2 = "d0736367";
const String ESCARA3 = "8034d84c";
const String ESCARA4 = "d0975e1e";
...
void loop(void) {
 if(juega){
  ...
  if(hey1 == ESCARA1 && hey2 == ESCARA2 && hey3 == ESCARA3 && hey4 == ESCARA4){Serial.println("OKA");digitalWrite(RELE_ESCARA, HIGH);juega = false;}
  else{if(((millis() - contador) > INTERVALO_RESET) && flag ){digitalWrite(RELE_RFID , LOW); delay(DELAY_RESET);digitalWrite(RELE_RFID , HIGH);contador = millis();}}
  delay(250);}
  laser();
} 
//1
...
void laser ()
{
  if(analogRead(A0) < 200){digitalWrite(RELE_LASER , HIGH);}
}
