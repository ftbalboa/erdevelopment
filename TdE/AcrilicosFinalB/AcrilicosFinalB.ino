...
#define SS_3_PIN        10          // Configurable, take a unused pin, only HIGH/LOW required, must be diffrent to SS 1

#define NR_OF_READERS   2

byte ssPins[] = {SS_2_PIN, SS_3_PIN};
//originales
byte RESPUESTA1A[] = {27, 160, 86, 211};
byte RESPUESTA1B[] = {167, 153, 71, 41};
//repuestos
byte RESPUESTA2A[] = {218, 201, 83, 211};
byte RESPUESTA2B[] = {17, 162, 83, 211};
